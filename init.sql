...
-- Seed: default admin (password: "admin123" — scrypt hash placeholder, replace after first login)
-- The actual hash will be generated by the backend's register endpoint.

-- ---------------------------------------------------------------------------
-- 3. FUNCTIONS & TRIGGERS
-- ---------------------------------------------------------------------------

-- 3.1 Automatic updated_at trigger for devices
